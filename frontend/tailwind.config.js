  ...
  theme: {
    extend: {
      fontFamily: {
        ...
        pixel: ["Good Timing", "BoldPixels", "Toxigenesis", "Press Start 2P", "Courier New", "monospace"],
        retro: ["Good Timing", "BoldPixels", "Toxigenesis", "VT323", "Courier New", "monospace"],
      },
      colors: {
        // Enhanced AmigoChat retro color palette
        primary: "#000000",
        secondary: "#FFFFFF",
        accent: "#FF4500",
        burntOrange: "#FF4500",
    ...
    function ({ addUtilities }) {
      const newUtilities = {
        ...
        ".scanline::before": {
          ...
          height: "100%",
          background:
            "linear-gradient(90deg, transparent, rgba(0,255,65,0.2), transparent)",
