export const Amigo_CHAT_ABI = [
  {
    type: "constructor",
    inputs: [
      { name: "_registrationFee", type: "uint256", internalType: "uint256" },
    ],
...
export const Amigo_CHAT_ADDRESS =
  (import.meta.env.VITE_Amigo_CHAT_CONTRACT as `0x${string}`) ||
  "0x6f457540f0F38e564b680b9b7c90393C46b4A8cb";
